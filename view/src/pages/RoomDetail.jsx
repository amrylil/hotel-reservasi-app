  ...
  const handleReservation = async () => {
    ...
    try {
      ...
      const res = await fetch('http://localhost:5000/api/reservations', {
        ...
        credentials: 'include', //  <-- pindahkan ke sini
        body: JSON.stringify({
          room: room._id,
          check_in: checkIn,
          check_out: checkOut,
          ...
          <div className="lg:col-span-2">
            <div className="space-y-4">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/20 shadow-2xl">
                <img
                  src={
                    room.images?.[selectedImage] || '/api/placeholder/800/500'
                  }
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/10 backdrop-blur-sm rounded-2xl p-6 border border-amber-500/20">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={
                      room.availability ? 'text-green-400' : 'text-red-400'
                    }
                  >
                    {room.availability
                      ? 'Available Now'
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Contact our reception for more information about this room or to
                make a reservation.
              </p>
